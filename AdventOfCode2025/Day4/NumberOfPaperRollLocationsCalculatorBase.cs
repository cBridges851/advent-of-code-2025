namespace Day4 {
    internal class NumberOfPaperRollLocationsCalculatorBase {
        ...
        public char[] GetSurroundingCells(int currentRow, int currentCol, char[][] grid) {
            ...
            var topRight = currentRow > 0 && currentCol < grid[currentRow - 1].Length - 1 ? grid[currentRow - 1][currentCol + 1] : ' ';
            ...
            var bottomRight = currentRow < grid.Length - 1 && currentCol < grid[currentRow + 1].Length - 1 ? grid[currentRow + 1][currentCol + 1] : ' ';
